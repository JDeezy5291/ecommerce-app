  ...
  <body class="text-center">
            ...
            <li class="nav-item">
              <?php 
                if (isset($_SESSION['u_email'])) {
                  echo '<a href="login.php" class="nav-link">Log Out</a>';
                } else {
    ...
    <!-- <section id="form">
      <form class="form-signin">
        <h1 class="h3 mb-3 font-weight-normal">New Customer</h1>
        ...
        <a class="btn btn-lg btn-primary btn-block" type="submit" href="#">Register</a>
      </form>
    </section> -->
    <section id="form">
      <form class="form-signin" action="includes/register.inc.php" method="post">
        ...
        <input type="text" class="form-control" name="uid" placeholder="Username" required autofocus>
