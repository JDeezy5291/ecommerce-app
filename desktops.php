...
<html lang="en">
  ...
  <body>
    ...
    <section id="showcase">
      <div class="desktop-pimg1">
        <div class="container-fluid">
          <div class="container">
            <div class="carousel-caption text-center mb-5" id="text-gray">
              <h1>Desktops</h1>
              <p>Find a Desktop to suit your Businesss, School or Gaming needs.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid mb-5">
        <div class="row m-2">
          <div class="card col-lg-4 col-md-6 item-fade">
            <h4 class="my-0 font-weight-normal text-center">Desktop</h4>
                    ...
                    <img src="<?php echo $product['image']; ?>" class="img-fluid">
                      <div class="col-sm-12 col-md-6 mx-auto text-center float-right">
                        <form method="POST" action="cart.php?action=add&id=<?php echo $product['id']; ?>">
                          <h4>Desktop</h4>
                          <p>This Desktop is amazing! You must buy one while they last.</p>
                          <hr>
