...
<html lang="en">
  ...
  <body>
    ...
    <section id="showcase">
      <div class="peripherals-pimg1">
        <div class="container-fluid">
          <div class="container">
            <div class="carousel-caption text-center mb-5">
              <h1>Peripherals</h1>
              <p>Peripherals to suit your Businesss, School or Gaming needs.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid mb-5">
        <div class="row m-2">
          <div class="card col-lg-4 col-md-6 item-fade">
            <h4 class="my-0 font-weight-normal text-center">Headphones</h4>
            <a href="#" id="myBtn" data-toggle="modal" data-target="#myModal_headphones"><img src="images/peripherals/headphones.jpeg" alt="Card image cap" class="img-fluid"></a>
            <!-- MODAL 2 -->
            <div class="modal fade" id="myModal_headphones">
                    ...
                    <img src="<?php echo $product['image']; ?>" class="img-fluid">
                      <div class="col-sm-12 col-md-6 mx-auto text-center float-right">
                        <form method="POST" action="cart.php?action=add&id=<?php echo $product['id']; ?>">
                          ...
                          <p>These Headphones are amazing! You must buy one while they last.</p>
                          <hr>
          ...
          <div class="card col-lg-4 col-md-6 item-fade">
            <h4 class="my-0 font-weight-normal text-center">Mouse</h4>
            <a href="#" id="myBtn" data-toggle="modal" data-target="#myModal_mouse"><img src="images/peripherals/mouse.jpeg" alt="Card image cap" class="img-fluid"></a>
            <!-- MODAL 2 -->
            <div class="modal fade" id="myModal_mouse">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                  ...
                  <div class="modal-body">
                    ...
                    <img src="<?php echo $product['image']; ?>" class="img-fluid">
                      <div class="col-sm-12 col-md-6 mx-auto text-center float-right">
                        <form method="POST" action="cart.php?action=add&id=<?php echo $product['id']; ?>">
                          <h4><?php echo $product['name']; ?></h4>
                          <p>This Mouse is amazing! You must buy one while they last.</p>
                          <hr>
                          <p class="float-left">In Stock</p>
                          <p>Price: $<?php echo $product['price']; ?></p>
                          <label class="float-left mr-3">Quantity:</label>
            ...
            <ul class="list-unstyled mt-3 mb-4 text-center">
              <li>List Price: <s>$79.99</s></li>
              <li>Our Price: $69.99</li>
            </ul>
          </div>
          <div class="card col-lg-4 col-md-6 item-fade">
            <h4 class="my-0 font-weight-normal text-center">Mouse</h4>
          ...
          <div class="card col-lg-4 col-md-6 item-fade">
            <h4 class="my-0 font-weight-normal text-center">Monitor</h4>
            <a href="#" id="myBtn" data-toggle="modal" data-target="#myModal_monitor"><img src="images/peripherals/monitor.png" alt="Card image cap" class="img-fluid"></a>
            <!-- MODAL 2 -->
